  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-display",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-to-r from-[hsl(186,100%,50%)] via-[hsl(200,100%,45%)] to-[hsl(220,80%,50%)] text-[hsl(222,47%,6%)] font-semibold hover:opacity-90 hover:shadow-lg hover:shadow-[hsl(186,100%,50%)/0.3] shadow-[0_0_60px_hsl(186,100%,50%,0.15)]",
        heroOutline: "border border-[hsl(186,100%,50%)/0.5] bg-transparent text-foreground hover:bg-[hsl(186,100%,50%)/0.1] hover:border-[hsl(186,100%,50%)]",
      },
      size: {
